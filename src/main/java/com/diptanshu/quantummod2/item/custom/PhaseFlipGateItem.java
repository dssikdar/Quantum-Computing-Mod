...
public class PhaseFlipGateItem extends Item
{
    public PhaseFlipGateItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (pLevel.isClientSide()) {
            if (clickedBlock instanceof QubitBlock) {
                ...
                qubitBlock.setStateVector(matrixMult(currentState, zMatrix), positionClicked);
